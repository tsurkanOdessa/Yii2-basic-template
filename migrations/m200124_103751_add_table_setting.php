...
class m200124_103751_add_table_setting extends Migration
{
    ...
    private function getSettingSql()
    {
        return "INSERT INTO {{%setting}} (`id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` , `title`) VALUES
                ...
                (1111, 11, 'themes', 'select', 'no_style,cerulean,cosmo,cyborg,darkly,default,flatly,journal,lumen,paper,readable,sandstone,simplex,slate,spacelab,superhero,united,yeti ', '', 'default', '50','Стиль'),
                (1112, 11, 'siteName', 'text', '', '', 'Your Site', '50','Название сайта'),
                (1113, 11, 'siteTitle', 'text', '', '', 'Your Site Title', '50','Заголовок сайта'),
                (1115, 11, 'siteKeyword', 'text', '', '', 'Your Site Keyword', '50','Ключевые слова'),
                (1114, 11, 'siteNav', 'select', 'off,top,left', '', 'top', '50','Панель навигации'),
